        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl opacity-90 max-w-3xl mx-auto">
              ...
              và chúng tôi sẽ liên hệ lại trong thời gian sớm nhất.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="space-y-8">
            <div className="bg-white rounded-lg p-6 shadow-md">
              ...
              <p className="text-gray-600">
                Bạn có thể đăng ký tài khoản miễn phí và bắt đầu khám phá các tính năng ngay lập tức. 
                Chúng tôi cũng cung cấp hướng dẫn chi tiết để giúp bạn làm quen với ứng dụng.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 shadow-md">
              ...
              <p className="text-gray-600">
                Có, chúng tôi cung cấp hỗ trợ khách hàng 24/7 thông qua chat trực tuyến, 
                email và điện thoại để đảm bảo bạn luôn nhận được sự trợ giúp khi cần.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 shadow-md">
              ...
              <p className="text-gray-600">
                Chúng tôi rất coi trọng bảo mật dữ liệu và tuân thủ các tiêu chuẩn bảo mật quốc tế. 
