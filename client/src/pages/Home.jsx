  ...
  const features = [
    {
      title: "Hiện đại",
      description:
        "Được xây dựng với các công nghệ React và Tailwind CSS mới nhất",
      icon: "⚡",
    },
    {
      title: "Responsive",
    ...
    },
    {
      title: "Tối ưu",
      description:
        "Được tối ưu hóa cho hiệu suất và trải nghiệm người dùng tốt nhất",
      icon: "🚀",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Ứng dụng web hiện đại được xây dựng với React, Tailwind CSS và các
              công nghệ tiên tiến nhất. Trải nghiệm giao diện đẹp mắt và hiệu
              suất tối ưu.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Khám phá những tính năng tuyệt vời của ứng dụng
            </p>
          </div>
